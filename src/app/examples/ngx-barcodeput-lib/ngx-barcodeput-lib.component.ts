...
@Component({
  selector: 'app-ngx-barcodeput-lib',
  templateUrl: './ngx-barcodeput-lib.component.html',
  styleUrls: ['./ngx-barcodeput-lib.component.scss']
})
export class NgxBarCodePutLibComponent implements AfterViewInit, OnDestroy {
